                    ...
                    <div class="paper container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6  col-sm-6">
                                ...
                                <input type="text" class="form-control" id="textCompCode" value="<?=$value->compID?>">
                            </div>
                        <? } ?>
                            <div class="col-lg-6 col-md-6  col-sm-6">
                                    ...
                                    <?php
                                        if(!empty($comps)){
                                            foreach($comps as $key => $value){
                                                echo $compClass =  $value->compClass ;
                                            }
                                        }
                                        if(!empty($drops)){
                                            foreach($drops as $key => $value){
                                                if($compClass == $value->dropVal){
                                                    echo '<option value="'.$value->dropVal.'" selected>'.$value->dropName.'</option>';
                                                }else{
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <input type="text" name="" class="form-control" id="textCompName" value="<?=$value->compName?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <label for="">Component Description</label>
                                <textarea name="" id="textCompDesc" cols="20" rows="5" class="form-control"><?=$value->compDescription?></textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <input type="text" class="form-control" id="textDimBasis" value="<?=$value->compRelativeDimSize?>">
                            </div>
                            <div class="col-sm-4">
                                <label for="">Unit</label><br>
                                <label for="" id="baseUnit"><?=$value->compUnit?></label>
                            </div>
                        </div>
                        <?php   }?>
                        <hr>
                        ...
                        <div class="row rounded" style="border:1px solid">
                            ...
                            <div class="col-sm-12 " style="border:1px solid">
                                <table id="materyalisKU" class="table table-hover">
                                    <thead>
                                        <th>Material Name</th>
                                        <th>Size </th>
                                        <th>Unit</th>
                                    ...
                                    <tbody>
                                    <?php foreach($compMat as $key => $value){
                                        echo' 
                                        <tr style="text-align:center;">
                                            <td><label>'.$value->matName.'</label></td>
                                            <td><input type="text" value="'.$value->cmSize.'" class="form-control"></td>
                                            <td><label>'.$value->matBaseUnit.'</label></td>
                                            <td><input type="text" value="'.$value->cmQty.'" class="form-control"></td>
                                            <td><label>'.$value->matUnitPrice.'</label></td>
                                            <td><input type="text" value="'.$value->cmWaste.'" class="form-control" disabled></td>
                                            <td><input type="text" value="'.$value->compPrice.'" class="form-control"></td>
                                            <td><input type="button" class="btn btn-outline-danger btn-xs" value="X"></td>
                                        </tr>
                                        ';
                                    }?>
